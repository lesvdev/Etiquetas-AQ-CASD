...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans antialiased">
      ...
      {/* 1. Barra Superior Responsiva e Institucional CASD */}
      <header className="bg-white border-b border-slate-200/90 sticky top-0 z-30 shadow-2xs">
        <div className="max-w-7xl mx-auto px-3 sm:px-6">
          <div className="flex items-center justify-between h-16 gap-2 sm:gap-4">
            {/* Logo Oficial CASD & Título */}
            <div className="flex items-center gap-2.5 min-w-0 flex-1">
              <CasdLogo size={38} className="shrink-0 hover:scale-105 transition-transform" />
              <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className="inline-flex items-center px-2 py-0.2 rounded-full text-[10px] sm:text-xs font-bold bg-emerald-50 text-emerald-800 border border-emerald-200 whitespace-nowrap">
                    {reagents.length} reactivos
                  </span>
                </div>
              </div>
            </div>
            ...
            {/* Acciones para Pantallas Grandes (Desktop / Tablet) */}
            <div className="hidden lg:flex items-center gap-2 shrink-0">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl shadow-2xs transition-colors"
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold bg-slate-900 hover:bg-slate-800 text-white rounded-xl shadow-2xs transition-colors"
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold bg-teal-600 hover:bg-teal-700 text-white rounded-xl shadow-2xs transition-colors"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-300 rounded-xl transition-colors"
            ...
            {/* Acciones en Mobile & Tablet (Botón Nuevo compacto + Botón Menú) */}
            <div className="flex lg:hidden items-center gap-1.5 shrink-0">
              <button
                id="btn-add-reagent-mobile"
                onClick={() => {
                  setEditingReagent(null);
                  setIsAddModalOpen(true);
                }}
                className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-bold bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl shadow-2xs transition-colors"
                title="Registrar nuevo reactivo"
              >
                <Plus className="w-3.5 h-3.5" />
                <span>Nuevo</span>
              </button>
              ...
              <button
                ...
                className={`inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-bold rounded-xl transition-colors border ${
                  isMobileMenuOpen
                    ? 'bg-slate-900 text-white border-slate-900'
                    : 'bg-slate-100 hover:bg-slate-200 text-slate-700 border-slate-200'
                }`}
                title="Opciones y herramientas del laboratorio"
          ...
          {isMobileMenuOpen && (
            <div className="lg:hidden border-t border-slate-100 py-3 grid grid-cols-2 gap-2 animate-in fade-in slide-in-from-top-2 duration-150">
              <button
                onClick={() => {
                  setIsMobileMenuOpen(false);
                  imagesInputRef.current?.click();
                }}
                className="flex items-center gap-2 p-2.5 bg-slate-50 hover:bg-slate-100 rounded-xl border border-slate-200 text-left text-xs font-bold text-slate-800 transition-colors"
              >
                <ImageIcon className="w-4 h-4 text-emerald-600 shrink-0" />
                <div className="truncate">
                  <span>Subir Fotos</span>
                  <span className="block text-[10px] font-normal text-slate-500">Imágenes locales</span>
                </div>
              </button>
              ...
              >
                ...
                <div className="truncate">
                  <span>Cargar CSV</span>
                  <span className="block text-[10px] font-normal text-slate-500">Importar lista</span>
                </div>
              </button>
              ...
              <button
                ...
                className="flex items-center gap-2 p-2.5 bg-emerald-50/70 hover:bg-emerald-100 rounded-xl border border-emerald-200 text-left text-xs font-bold text-emerald-900 transition-colors"
              >
                <FileSpreadsheet className="w-4 h-4 text-emerald-700 shrink-0" />
                <div className="truncate">
                  <span>Descargar Excel</span>
                  <span className="block text-[10px] font-normal text-emerald-700/80">Listado .xlsx</span>
                </div>
              </button>
              ...
              <button
                ...
                className="flex items-center gap-2 p-2.5 bg-slate-50 hover:bg-slate-100 rounded-xl border border-slate-200 text-left text-xs font-bold text-slate-700 transition-colors"
              >
                <RotateCcw className="w-4 h-4 text-slate-500 shrink-0" />
                <div className="truncate">
                  <span>Restaurar (70)</span>
                  <span className="block text-[10px] font-normal text-slate-500">Datos de fábrica</span>
                </div>
              </button>
            </div>
          )}
